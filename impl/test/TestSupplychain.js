...
contract('SupplyChain', function(accounts) {
    ...
    it("Testing smart contract function harvest that allows a farmer to harvest the seed", async() => {
        ...
        await supplyChain.harvest(productionID, farmerID, harvestTime, farmerName, fieldName, latitude, longitude);

        // Retrieve farm data from oil production
        const result = await supplyChain.fetchOilProductionFarm.call(productionID);

        // Verify the result set
        assert.equal(result[0], farmerID, 'Error: Missing or Invalid ownerID')
